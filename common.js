const Nenge = new class NengeCores {
    ...
    constructor() {
        ...
        I[1].assign(T, {
            ...
            openServiceWorker(file) {
                if ('serviceWorker' in navigator) {
                    T.serviceActive = !0;
                    navigator.serviceWorker.register(file).then(w => {
                        I[1].assign(T, {
                            serviceWorker: w.active,
                            PostMessage: str => navigator.serviceWorker.controller.postMessage(str)
        ...
        T.MediaQuery('(prefers-color-scheme: light)', bool => I.Attr(I.$('html'), {
    ...
    async FetchItem(ARG) {
        ...
        if(I.u8buf(contents)){
            if(I.CArr([I.L(33),I.L(32),F.html],ARG.type||type)){
                ...
                return I.Async(async re=>{
                    ...
                    await I.Async(I.toArr(contents).map(async entry => {
                        let filename = F.getname(entry[0]),
                            ...
                            filedata = entry[1],
                            type = I.L(11);
                            if(I.CArr([I.L(33),I.L(32),F.html],ARG.unbuf||filetype)){
    ...
    ajax(ARG) {
        ...
        return I.Async((resolve) => {
            ...
            let ResHeaders,ReType,success = (...a)=>{ARG.success && ARG.success.apply(request,a);resolve(a[0]);},error = (...a)=>{ARG.error && ARG.error.apply(request,a);resolve(null);},heads=I.NN(I[31].head)
            ;
    ...
    I = new class NengeType {
        constructor(T) {
            ...
            Object.assign(I, {
                ...
                getProp: (o, n) => o.getPropertyValue(n),
                ...
                CArr(o,...a){
                    for(let i=0;i<a.length;i++){
                        if(o.includes(a[i]))return !0;
                    }
                    return !1;
                },
                Cobj(o,...a){
                    for(let i=0;i<a.length;i++){
                        if(I.IF(a[i],o))return !0;
                    }
                    return !1;
                },
                Item(o, fn) {
                    for (let i = 0; i < o.length; i++) fn(o.item(i))
                },
                EachItem: (o, a) => !(a = []) || I.Item(o, v => {
                    if (I.str(v) && o.getPropertyValue) a.push([v, I.getProp(o, v)]);
    ...
    F = new class NengeUtil {
        ...
        dbWriteItem(DB, name, data) {
            let F = this;
            if (data){
                if(F.I.Cobj(34,data,data&&data.contents)){
